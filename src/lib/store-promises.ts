/**
 * Customer-facing promises shared by cart + checkout.
 * Null = do not render. Never invent policy language here.
 */
...
export const SHIPPING_PROMISE = "Free shipping on 3+ pairs";
