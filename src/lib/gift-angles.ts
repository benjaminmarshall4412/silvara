...
export const GIFT_ANGLES: Record<GiftAngle, GiftHeroCopy> = {
  "hard-to-shop": {
    ...
    subheadline:
      "Thin silver crew socks for long shifts and work boots—useful every week, not another drawer item.",
  },
  "long-shift": {
    eyebrow: "3-pair gift set",
    headline: "Built for the long day.",
    subheadline:
      "Three pairs of thin silver crew socks for boots, hard floors, and shifts that run long.",
  },
  odor: {
    eyebrow: "3-pair gift set",
    headline: "Silver yarn. Not perfume.",
    subheadline:
      "Three pairs of thin crew socks that help manage odor in the fabric—no scent cover-up.",
  },
};
