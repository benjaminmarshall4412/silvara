  ...
  us: [
    {
      ...
      amount: 1299,
      lookupKey: "silvara_single_usd_onetime_v3",
    ...
    },
    {
      ...
      amount: 2999,
      lookupKey: "silvara_triple_usd_onetime_v3",
  ...
  uk: [
    {
      ...
      description: "Single pair trial pack",
      amount: 1000,
      lookupKey: "silvara_single_uk_gbp_onetime_v3",
    ...
    },
    {
      ...
      description: "Main workweek rotation bundle",
      amount: 2000,
      lookupKey: "silvara_triple_uk_gbp_onetime_v4",
